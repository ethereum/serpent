...
Mapping mapping[] = {
    ...
    Mapping("SLOADEXT", 0x5c, 2, 1),
    Mapping("SSTOREEXT", 0x5d, 3, 0),
    Mapping("SLOADBYTESEXT", 0x5c, 4, 0),
    Mapping("SSTOREBYTESEXT", 0x5d, 4, 0),
    ...
    Mapping("CALLBLACKBOX", 0xf5, 7, 1),
    Mapping("RNGSEED", 0xf6, 1, 1),
    Mapping("SSIZEEXT", 0xf7, 2, 1),
    Mapping("SLOADBYTES", 0xe1, 3, 0),
    Mapping("SSTOREBYTES", 0xe2, 3, 0),
    Mapping("SSIZE", 0xe3, 1, 1),
